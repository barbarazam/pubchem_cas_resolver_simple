# v6 adds command line flags for input and output folders
# problem: hardcoded folder names mean you have to edit the code every time
# now you can run: python v6_cli.py --input-dir my_data --output-dir my_results
